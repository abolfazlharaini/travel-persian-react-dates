...
storiesOf('withStyles', module)
  .add('CalendarDay', withInfo()(() => (
    <table>
      <tbody>
        <tr>
          <CalendarDay momentConfig={momentConfigDefault} />
          <CalendarDay momentConfig={momentConfigDefault}
          //isOutsideDay 
          />
          <CalendarDay momentConfig={momentConfigDefault}
          // modifiers={new Set(['highlighted-calendar'])} 
          />
          <CalendarDay momentConfig={momentConfigDefault}
          // modifiers={new Set(['blocked-minimum-nights'])} 
          />
          <CalendarDay momentConfig={momentConfigDefault} modifiers={new Set(['selected-span'])} />
          <CalendarDay momentConfig={momentConfigDefault} modifiers={new Set(['selected'])} />
          <CalendarDay momentConfig={momentConfigDefault} modifiers={new Set(['selected-start'])} />
          <CalendarDay momentConfig={momentConfigDefault} modifiers={new Set(['selected-end'])} />
          <CalendarDay momentConfig={momentConfigDefault} modifiers={new Set(['hovered-span'])} />
          <CalendarDay momentConfig={momentConfigDefault}
          // modifiers={new Set(['after-hovered-start'])}
          />
          <CalendarDay momentConfig={momentConfigDefault}
          //modifiers={new Set(['blocked-calendar'])}
          />
          <CalendarDay momentConfig={momentConfigDefault} modifiers={new Set(['blocked-out-of-range'])} />
        </tr>

        <tr>
          <CustomizableCalendarDay defaultStyles={customStyles} />
          <CustomizableCalendarDay //isOutsideDay 
            outsideStyles={customStyles} />
          <CustomizableCalendarDay
            //modifiers={new Set(['highlighted-calendar'])} 
            highlightedCalendarStyles={customStyles} />
          <CustomizableCalendarDay
            //modifiers={new Set(['blocked-minimum-nights'])} 
            blockedMinNightsStyles={customStyles} />
          ...
          <CustomizableCalendarDay
            // modifiers={new Set(['after-hovered-start'])} 
            afterHoveredStartStyles={customStyles} />
          <CustomizableCalendarDay
            // modifiers={new Set(['blocked-calendar'])} 
            blockedCalendarStyles={customStyles} />
