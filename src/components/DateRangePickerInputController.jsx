...
export default class DateRangePickerInputController extends React.PureComponent {
  ...
  onEndDateChange(endDateString) {
    ...
    const endDate = toMomentObject(endDateString, this.getDisplayFormat(), momentConfig);
  ...
  onStartDateChange(startDateString) {
    ...
    const startDate = toMomentObject(startDateString, this.getDisplayFormat(), momentConfig);
  ...
  getDateString(date) {
    ...
    return toLocalizedDateString(date, undefined, this.props.momentConfig);
  }
